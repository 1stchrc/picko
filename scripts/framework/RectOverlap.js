var RectOverlap = function(){
    var overlapedRects = new Misc.ObjList();
    RectOverlap = {
        ...
        GridLayer: function (sizeX,sizeY,scaleX,scaleY){
            ...
            for(var i = 0; i < this.gridList.length; i++){
                this.gridList[i] = new Misc.ObjList();
            }
            
        }
    };
    RectOverlap.GridLayer.prototype = {
        ...
        updateRect : function(rect,l,r,b,t){
